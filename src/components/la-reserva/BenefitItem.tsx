...
const BenefitItem: FC<BenefitItemProps> = ({
  ...
  return (
    <div
      onClick={onSelect}
      className="group/item flex cursor-pointer flex-col items-center px-6 py-7 transition-all hover:scale-105 hover:shadow-md hover:shadow-primary/10"
    >
      <div className="mb-2 rounded-full bg-slate-50 p-3 transition-colors group-hover/item:bg-slate-100">
        <Icon className="group-hover/item:animate-stroke size-10 stroke-1 text-primary" />
      </div>
